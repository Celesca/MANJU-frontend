      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 pt-16 pb-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 lg:gap-8 mb-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex flex-col">
              <span className="text-2xl font-bold text-white tracking-tight leading-none">MANJU</span>
              <span className="text-[10px] font-medium tracking-[0.2em] text-slate-500 uppercase leading-none mt-1">
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-slate-500 text-sm">
            &copy; 2025 MANJU Powered by LIMITLESS. All rights reserved.
          </p>
