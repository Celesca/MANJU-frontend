...
import ProjectsContent from '../src/pages/ProjectsContent';
...
describe('ProjectsContent', () => {
    ...
    it('opens create modal and creates project', async () => {
        ...
        // Since there are multiple buttons (one in header, one in empty state if applicable)
        // We find the one in header. 'New Project' text.
        const newProjectBtn = screen.getByText('New Project');
        fireEvent.click(newProjectBtn);

        // Fill form
        const nameInput = screen.getByPlaceholderText('My Voice Workflow'); 
